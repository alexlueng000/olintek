      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-100">我们的产品</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">SkyLoad iQ</a>
              </h3>
              <p className="text-lg text-slate-500 leading-relaxed">航空公司的配载规划人员，透过直观的 3D 图形，能够清楚地了解飞机货舱内各个 ULD的搭载位置、货物装载密度以及重量分布等关键信息，查看您的飞机还剩下多少个舱位，快速掌握舱位的销售报价，使决策者能够更准确地制定装载计划和进行必要的调整，同时最大化地利用飞机货舱的舱位和重量限制。</p>
            </article>
            ...
            <article data-aos="fade-up" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">SkyCube iQ</a>
              </h3>
              <p className="text-lg text-slate-500 leading-relaxed">协助 GHA、GSA、以及航空货运代理，进一步提升作业效率并确保货物装载质量。对于包机可快速制作包机的装载方案与报价，货站的组板装载、货代的提单预订条件，进行货物量的精准预测，自动进行装载空间的优化计算，快速准确地估算所需的ULD类型和数量，以确保每个ULD的使用效益最大化。</p>
            </article>
            ...
            <article data-aos="fade-up" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">SkyOptimizer</a>
              </h3>
              <p className="text-lg text-slate-500 leading-relaxed">SkyOptimizer 考虑货物的总重量和体积不超过飞机的容量，同时最大程度地利用舱位的空间。我们提供与外部系统的数据接口，可以灵活的使用SkyOptimizer API 的功能来满足与各种系统数据接口的开发需求。例如：与企业内部管理系统的数据接口以及将 SkyOptimizer 集成到您的系统中。</p>
            </article>
