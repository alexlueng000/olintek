    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-4 lg:max-w-xs">
            <div className="mb-2">
              ...
              <img src="/images/OLINTEK-LOGO-PNG.png" alt="logo" className="w-20 h-8 fill-current" />
            </div>
            <div className="text-lg font-bold text-slate-800">超越经验的世界</div>
          </div>

          {/* 2nd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-800 font-semibold mb-2">如何工作</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">概览</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">价格</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">服务地区</a>
              </li>
            </ul>
          </div>
          ...
          {/* 3rd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-800 font-semibold mb-2">资源</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">客户故事</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">知识背景</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">联系我们</a>
              </li>
            </ul>
          </div>
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-800 font-semibold mb-2">产品</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">合作伙伴</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">安全认证</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">法律帮助</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">战略计划</a>
              </li>
            </ul>
          </div>
          ...
          {/* 5th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-800 font-semibold mb-2">公司</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">关于我们</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">招募</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">使用术语</a>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-6 md:py-8 border-t border-slate-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-slate-500 mr-4">© OLINTEK. All rights reserved.</div>
