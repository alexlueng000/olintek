      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-10">
            ...
            <p className="text-xl text-slate-500 text-left leading-relaxed">装货计算能力是装柜软件最基本的要求,即使拥有再多的功能,计算结果不好,也是无法达到实质效用。SkyLoadiQ不但拥有强大的功能可以满足您实际的飞机配载、货物打板作业需求,快速、稳定以及坚强的计算能力更是我们长期以来所坚持、不断研发突破并且引以自豪的利器。</p>
          </div>
