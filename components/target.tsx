      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-800 mb-6">智力超群的运算力</h2>
            <p className="text-base text-slate-500 text-left leading-relaxed">装货计算能力是装柜软件最基本的要求,即使拥有再多的功能,计算结果不好,也是无法达到实质效用。SkyLoadiQ不但拥有强大的功能可以满足您实际的飞机配载、货物打板作业需求,快速、稳定以及坚强的计算能力更是我们长期以来所坚持、不断研发突破并且引以自豪的利器。</p>
          </div>
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-col md:items-center md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            {/* Gifs */}
            <div className="max-w-6xl px-4 sm:px-6 mt-10">
              <div className="w-full grid gap-12 sm:grid-cols-2 md:grid-cols-4 md:-mx-5 md:gap-10 items-start md:max-w-none justify-center">
