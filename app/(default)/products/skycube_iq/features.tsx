    ...
    const features: FeatureProps[] = [
        {
            ...
            title: 'ULD的堆叠方向限制',
            text: '航空货物在打板作业中，通常需要根据货物的特性和尺寸，选择合适的堆叠方向。同时，还要考虑ULD的承载能力和稳定性，确保货物在装载过程中不会倾斜或损坏。对于混装货物的情况，可以灵活地选择横向堆叠和纵向堆叠的组合，以最大限度地利用ULD的空间，并确保货物的安全运输。',
        },
        {
            icon: (<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-plane-tilt stroke-lime-500" width="48" height="48" viewBox="0 0 24 24" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        },
        {
            ...
            title: 'AWB的装载顺序考虑',
            text: 'AWB（空运货物提单，Air Waybill）的装载顺序限制是指在货物的装载过程中，可自由指定 AWB 的货物装卸先后顺序，确保在目的地卸货时，按照相应 AWB的顺序快速卸货，方便进行分拣作业。',
        },
        {
            icon: (<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-plane-tilt stroke-lime-500" width="48" height="48" viewBox="0 0 24 24" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        },
        {
            ...
            title: '相同群组的货物装载考虑',
            text: '可自由指定每个不同的 AWB 视为相同群组，尽可能装载在同一个 ULD 中。为了满足打板规定的要求，自动计算相同群组的货物装载在同一个 ULD ，减少装卸和处理的次数，实现相同群组货物的优化装载，提高装载效率和准确性。',
        },
        {
            icon: (<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-plane-tilt stroke-lime-500" width="48" height="48" viewBox="0 0 24 24" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
